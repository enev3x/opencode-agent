...
const UNKNOWN_SUBAGENT_MESSAGE =
  "Unknown subagent_type '<name>'. Available ELIGIBLE agents: odin, heimdall, einherjar, thor (if D-36 applied). Use delegate-task for read-only agents like volva, bragi, vidar, urd, forseti, huginn."
