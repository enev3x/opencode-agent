...
type ThorAgentsMdInjectorOptions = {
...
export function createThorAgentsMdInjectorHook(
  ctx: PluginInput,
  modelCacheState?: ContextLimitModelCacheState,
  options?: ThorAgentsMdInjectorOptions,
) {
  ...
  async function chatMessage(
    ...
    if (getAgentConfigKey(getEffectiveAgent(input, output)) !== "thor") return
