...
export const HOOK_NAME = "mimir-md-only"

export const PROMETHEUS_AGENT = "mimir"
 ...
 */
export const PLANNING_CONTEXT_OPEN = `<planning-context source="mimir-read-only">`
...
You are being invoked by ${getAgentDisplayName("mimir")}, a planning agent restricted to .omo/*.md plan files only.
...
│      │    - task(agent="Urd - Plan Consultant", ...)     │
...
│      │    - task(agent="Forseti - Plan Critic", ...)         │
