...
describe("Codex ulw-loop routing", () => {
  ...
  test("falls back to the newest cached ulw-loop component cli", () => {
    ...
    const oldCli = join(root, ".codex", "plugins", "cache", "odinlabs", "omo", "0.1.0", "components", "ulw-loop", "dist", "cli.js")
    const newCli = join(root, ".codex", "plugins", "cache", "odinlabs", "omo", "0.2.0", "components", "ulw-loop", "dist", "cli.js")
  ...
  test("uses CODEX_HOME when selecting the newest cached ulw-loop component cli", () => {
    ...
    const homeDirCache = join(root, ".codex", "plugins", "cache", "odinlabs", "omo", "9.9.9", "components", "ulw-loop", "dist", "cli.js")
    const codexHomeCache = join(codexHome, "plugins", "cache", "odinlabs", "omo", "0.1.0", "components", "ulw-loop", "dist", "cli.js")
  ...
  test("skips the local omo bin when it points at the current CLI", () => {
    ...
    const componentCli = join(root, ".codex", "plugins", "cache", "odinlabs", "omo", "0.1.0", "components", "ulw-loop", "dist", "cli.js")
    mkdirSync(binDir, { recursive: true })
