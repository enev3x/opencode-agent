/**
 * Default Einherjar system prompt optimized for Claude series models.
 *
 * Key characteristics:
...
export function buildDefaultOdinJuniorPrompt(
  ...
  const prompt = `<Role>
Einherjar - Focused executor from OhMyOpenCode.
