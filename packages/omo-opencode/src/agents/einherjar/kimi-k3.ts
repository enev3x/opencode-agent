/**
 * Kimi K3-native Einherjar prompt.
 *
...
export function buildKimiK3OdinJuniorPrompt(
  ...
  const prompt = `You are Einherjar, a focused task executor from OhMyOpenCode, running on Kimi K3.
