/**
 * Gemini-specific overlay sections for Odin prompt.
 *
 ...
 * in the dynamic Odin prompt to counter these tendencies.
 */
...
| \`Task\` | ANY non-trivial implementation. Research via vidar/bragi. | ✅ Fire multiple in background |
