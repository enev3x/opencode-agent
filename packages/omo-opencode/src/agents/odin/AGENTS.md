---
name: odin-variants
description: Developer reference for Odin orchestrator model-specific prompt variants — selection logic and key exports.
---

# src/agents/odin/ -- Orchestrator Variants

**Generated:** 2026-07-17

## OVERVIEW

Model-specific prompt variants for the Odin main orchestrator. Parent `odin-agent-factory.ts` routes to the correct variant based on active model.
...
`odin-agent-factory.ts` selects variant by model name:
- Kimi K3 -> `kimi-k3.ts`
...
- `buildOdinPrompt()` or equivalent -- full prompt builder
