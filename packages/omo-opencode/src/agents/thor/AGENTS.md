---
name: thor-agent
description: Developer reference for the Thor autonomous deep worker agent — model variants, key behaviors, and delegation patterns.
---

# src/agents/thor/ -- Autonomous Deep Worker

**Generated:** 2026-05-15

## OVERVIEW

6 files. Thor agent -- autonomous deep worker with GPT-5.4, GPT-5.5, GPT-5.6, and base-prompt variants. Goal-oriented: give it objectives, not step-by-step instructions. "The Legitimate Craftsman."

## FILES

| File | Purpose |
|------|---------|
| `agent.ts` | `createThorAgent()` factory, model-variant routing |
...
- Uses `run_in_background=true` for explore/bragi
