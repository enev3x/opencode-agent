...
const PROMPT_SIGNATURES = [
  ...
  {
    path: "packages/prompts-core/prompts/heimdall/default.md",
    label: "Heimdall default",
    signature: "You are Heimdall - the Master Orchestrator from OhMyOpenCode.",
  },
  {
    path: "packages/prompts-core/prompts/heimdall/gemini.md",
    label: "Heimdall Gemini",
    signature: "Your value is ORCHESTRATION, not coding.",
  },
  {
    path: "packages/prompts-core/prompts/heimdall/gpt.md",
    label: "Heimdall GPT",
    signature: "This prompt is outcome-first. Choose the most efficient path to the outcomes above.",
  },
  {
    path: "packages/prompts-core/prompts/heimdall/kimi.md",
    label: "Heimdall Kimi",
    signature: "Trust the trained prior on the hard 30% (verification reasoning, failure diagnosis, dependency analysis).",
  },
  {
    path: "packages/prompts-core/prompts/heimdall/opus-4-7.md",
    label: "Heimdall Opus 4.7",
    signature: "Opus 4.7 spawns fewer subagents than Opus 4.6 unless told otherwise.",
  },
  {
    path: "packages/prompts-core/prompts/mimir/default.md",
    label: "Mimir default",
