...
- Round 1: <result>
- Round 2: <result>
<!-- At 2 consecutive failures, invoke Volva Triple (see 04-volva-triple.md). -->
...
## Volva Triple (if invoked)
<!-- One subsection per Volva round, with the synthesized new hypothesis set. -->
