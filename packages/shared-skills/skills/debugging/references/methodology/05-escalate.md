...
- You've **exhausted the Volva Triple** and another 2 rounds failed after synthesis.

## Do NOT ask when

- You haven't tried the Volva Triple yet.
...
- **Escalating before Phase 4.** If you haven't tried the Volva Triple, you haven't earned the right to escalate.
