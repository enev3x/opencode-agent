...
| Surface competing directions and trade-offs | `design-debate` | `ulw-plan` | When direction is ambiguous, ask Mimir to present 2-3 options with accessibility and usability trade-offs before choosing defaults. |
...
Add design-specific acceptance criteria to the Mimir plan:
...
- `writing-design-plans` content is used only as task-quality guidance; Mimir remains the source of executable TODOs.
