...
//
// WRITE BOUNDARY: the mimir-md-only hook gates Write/Edit but NOT Bash, so
...
// packages/omo-opencode/src/hooks/mimir-md-only/path-policy.ts.
...
// enforcement of the mimir planner write boundary.
