...
Roles: `explorer` (internal patterns/conventions/tests), `bragi` (external docs/contracts), `urd` (gap analysis), `forseti` (high-accuracy plan review). Full spawn/wait/fallback discipline is in `references/full-workflow.md`.
