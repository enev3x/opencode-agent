...
| Unknown library behavior | Use bragi/docs or inspect examples. |
| Architecture uncertainty | Consult volva after forming concrete options. |
...
| External docs or API uncertainty | Delegate bragi or query docs. |
| Hard architecture/debugging after 2 attempts | Ask volva with evidence and options. |
...
| bragi agent | Official docs, external examples, APIs | Current guidance with source names |
| volva agent | Conflicting evidence or hard design choice | Recommendation with tradeoffs |
