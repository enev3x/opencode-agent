...
- The five mirrored chains are keyed only by `explore`, `bragi`, `urd`, `forseti`, and `volva`.
...
- The Volva head remains the hand-transcribed GPT-5.5 high entry required by the plan.
